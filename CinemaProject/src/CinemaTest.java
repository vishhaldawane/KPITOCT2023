...
class Kitchen
{
			MilkShake blend(Milk milkObj, Mango mangoObj, Sugar sug, Ice ice)
			{
			...
			Lassi blend(Curd curdObj, Sugar sug, Ice ice) {
				
				Lassi lassi = new Lassi();
				return lassi;
			}
			
			CurdRice blend(Curd curdObj, Rice sug, Salt salt) {
				
				CurdRice cr = new CurdRice();
				return cr;
			}
}
